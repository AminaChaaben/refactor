---
name: rrd-detect-duplication
description: 'Find redundant or near-duplicate code via structural graph similarity. Use when the user says "detect duplication" or "find duplicate test code"'
---

# Detect Duplication

**Goal:** Find redundant or near-duplicate functions/classes/test blocks via structural graph similarity — with a similarity score and a factor-out proposal (18% of false-fails in the reference engagement).
