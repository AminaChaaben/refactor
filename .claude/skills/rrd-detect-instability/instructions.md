...
Finds fragile selectors, fixed waits/timeouts, and unhandled overlays/iframes/alerts that make tests flaky, with file:line precision and a suggested stable replacement. Where execution logs exist, findings are corroborated against real failure/rerun logs, sharpening confidence. This root-cause family accounted for 18% of false-fails in the reference engagement.
